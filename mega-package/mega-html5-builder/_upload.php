<?php
	...
	$uploads_dir = 'elements/usr_uploads';//specify the upload folder, make sure it's writable!
	$relative_path = '../usr_uploads';//specify the relative path from your elements to the upload folder
